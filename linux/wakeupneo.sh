...
" 2>/dev/null; then
        ...
        echo -e " \033[90m Update:  curl -sL \033]8;;https://matrixshader.com/linux\007matrixshader.com/linux\033]8;;\007 | bash\033[0m"
        echo
    fi
}
...
" 2>/dev/null)
        ...
        echo -e "${CYAN} \033]8;;https://matrixshader.com/redpill\007matrixshader.com/redpill\033]8;;\007${RESET}"
    fi
