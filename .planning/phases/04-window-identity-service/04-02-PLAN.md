...
<task type="auto">
  <name>Task 1: Add IsWindow P/Invoke to WindowsApi</name>
...
<task type="auto">
  <name>Task 2: Implement batch WMI and UI Automation in IdentityService</name>
...
2. IsWindow P/Invoke declared in WindowsApi
3. IsHandleValid checks both IsWindow AND IsWindowVisible
4. BatchQueryCommandLines builds OR-joined WMI query
5. GetUIAutomationIdentity tries TermControl (0.95), TabItem (0.85), Name (0.90) in order
6. FindMatrixWindows uses batch WMI cache
7. All WindowInfo results have correct Confidence values
</verification>
