...
### Current Phase: Control Panel Hardening
...
- [ ] US-005: Remove dead code (space key handler)
- [ ] US-006: Robust window detection (match by title+process)
- [ ] US-007: Robust window positioning (use title matching)
- [ ] US-008: Poll-based window launch (replace sleep with active polling)
- [ ] US-009: Diagnostic logging (optional verbose logging to debug.log)
- [ ] US-010: Consolidate key handlers (DRY up duplicate handlers)
